...
entity_set = te.get_entity(path_to_KB_file,type_string,entity_string)
print len(entity_string)

entity2type = te.get_entity2type(path_to_KB_file,statement2type,entity_set,default_type,subject_string)
print len(entity2type)

event_set = ee.get_event(path_to_KB_file,type_string,event_type)
print len(event_set)


event2type = ee.get_event2type(path_to_KB_file,statement2type,event_set ,event_type,subject_string)
print len(event2type)



event2entity = ee.get_event2entity(path_to_KB_file,statement_set,entity_string,event_set,object_string,subject_string)
...
event2prefName = ee.get_event2prefName(path_to_KB_file,event_set,justification_set,jusby_string,justification2label)
event2doc = ee.get_event2doc(path_to_KB_file,event_set,justification_set,jusby_string,justification2source)
print len(event2doc)
